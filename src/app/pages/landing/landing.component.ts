        ...
        <div class="container mx-auto px-6 relative z-10 text-center py-20">
          <div class="hero-content">
            ...
            <p class="hero-subtitle">
              Discover amazing products at unbeatable prices with our curated
              collection of premium items
            </p>
      ...
      <div class="products-section container mx-auto px-6 py-16">
        ...
        >
          <div *ngFor="let product of products" class="product-card">
            <p-card
              styleClass="h-full shadow-md hover:shadow-lg transition-shadow duration-300"
            >
              <!-- Product Image -->
